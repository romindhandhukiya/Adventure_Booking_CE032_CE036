...
import 'package:cardone1/screens/home_screen.dart';
          ...
          child: Container(
            ...
            child: Row(
                ...
                children: <Widget>[
                  ...
                  // SizedBox(width: 5.0,),
                  Text("Google",style:TextStyle(fontFamily: 'Poppins',fontSize: 14,fontWeight: FontWeight.w300,color: Colors.black)),
                ]
            ),
          )
          ...
          child: Container(
            ...
            child: Row(
                children: <Widget>[
                  ...
                  // SizedBox(width: 2.0,),
                  Text("Facebook",style:TextStyle(fontFamily: 'Poppins',fontSize: 14,fontWeight: FontWeight.w300,color: Colors.black)),
                ]
            ),
          )
